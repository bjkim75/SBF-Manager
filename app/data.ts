...
export const menus=[['업무 관리',['대시보드','SBF 마스터','계층 트리','IA–L3 매핑']],['변경 관리',['변경요청','내 요청','처리 업무','변경 전후 비교','변경이력','Jira 반영 관리']],['데이터 운영',['데이터 가져오기','데이터 내보내기','버전 관리','기준정보']],['시스템',['사용자·권한','환경 설정']]] as const;
